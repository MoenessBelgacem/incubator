    ...
    <div class="min-h-screen bg-background flex">
      ...
      <aside
        ...
        <div class="h-16 flex items-center gap-2.5 px-6 border-b border-slate-100">
          ...
          <span class="text-sm font-bold font-display text-text-primary">Mentor<span class="text-primary-600">Space</span></span>
        </div>

        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          <span class="px-4 text-[10px] font-semibold text-text-muted uppercase tracking-widest">Coaching</span>
          <a routerLink="/mentor" routerLinkActive="sidebar-link-active" [routerLinkActiveOptions]="{exact:true}" class="sidebar-link">
          ...
          <a routerLink="/mentor/profile" routerLinkActive="sidebar-link-active" class="sidebar-link">
        ...
        <div class="p-4 border-t border-slate-100">
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-xs text-text-muted">Mentor Expert</p>
            </div>
      ...
      <div class="flex-1 ml-0 lg:ml-64">
        <header class="h-16 bg-white border-b border-slate-100 flex items-center justify-between px-6 sticky top-0 z-30">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="badge bg-primary-100 text-primary-700">Mentor</span>
          </div>
